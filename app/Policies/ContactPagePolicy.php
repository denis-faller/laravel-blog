...
class ContactPagePolicy
{
    ...
    /**
    * Определение, может ли страница контактов просматриваться текущим пользователем
    ...
    */
    ...
    /**
    * Определение, может ли страница контактов редактироваться текущим пользователем
    * @param  \Blog\User $currentUser
    * @return bool
    */
